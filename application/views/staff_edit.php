...
<!-- Begin Page Content -->
  <div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-user-friends"></i> Profile</h1>
   
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between">
        <h6 class="m-0 font-weight-bold text-info">Edit Profile</h6>
		<a href="<?php echo base_url(); ?>user/profile/<?php echo $this->session->userdata('staffid'); ?>" class="btn btn-info"><i class="fas fa-angle-left"></i> Back</a>
		
    </div>
      <div class="card-body">
        <?php echo form_open_multipart(base_url().'user/edit/'.$staffid);?>
